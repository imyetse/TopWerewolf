...
public class MemberFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return root = inflater.inflate(R.layout.library__fragment_member, container, false);
    }
    ...
    void initView() {
        ...
        View headView = LayoutInflater.from(context).inflate(R.layout.library__member_head_view, null, false);
        View zoomView = LayoutInflater.from(context).inflate(R.layout.library__member_zoom_view, null, false);
        View contentView = LayoutInflater.from(context).inflate(R.layout.library__member_content_view, null, false);
