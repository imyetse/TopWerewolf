...
public class MediaActivity extends BaseActivity implements ActivityFragmentView {
    ...
    private StateListDrawable createDefaultOverButtonBgDrawable() {
        ...
        int pressedColor = ThemeUtils.resolveColor(this, R.attr.gallery_toolbar_over_button_pressed_color, R.color.gallery_green_pressed);
        pressedDrawable.getPaint().setColor(pressedColor);

        int normalColor = ThemeUtils.resolveColor(this, R.attr.gallery_toolbar_over_button_normal_color, R.color.gallery_green);
        ...
        int disabledlColor = ThemeUtils.resolveColor(this, R.attr.gallery_toolbar_over_button_normal_color, R.color.gallery_green_disabled);
        ShapeDrawable disabledDrawable = new ShapeDrawable(new RoundRectShape(round, null, null));
        disabledDrawable.setPadding(dp12, dp8, dp12, dp8);
        disabledDrawable.getPaint().setColor(disabledlColor);
